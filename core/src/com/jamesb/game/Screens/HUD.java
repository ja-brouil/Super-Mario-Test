...
public class HUD implements Disposable{
    ...
    public HUD(SpriteBatch sb) {
        ...
        // Top Row
        table.add(marioLabel).expandX().pad(5); // Expand extends the label to fill the whole row. If you multiple things that are expanded, they will each share equally the space on the screen. Pad = pad the top by X pixels
    ...
    // avoid using this as static, not a good idea. Pass around the HUD if needed. Just for time saving practice
    public static void addScore(int points){
        HUD.score += points;
        scoreLabel.setText(String.format("%06d", HUD.score));
    }
